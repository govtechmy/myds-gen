...
class GenerateComponent:
    ...
    def __init__(self, prompt):
        if not design.prompt_validation(prompt):
            raise ValueError("Prompt provided was not valid. Please enter a prompt about a web component")
        self.prompt = prompt
    ...
    def component_generation_new(self):
        ...
        p_bar.update()
        self.component_string = component_generation.generate(self.component_task, self.full_context)
        p_bar.update()
    ...
    def component_iteration(self, update_prompt):
        ...
        self.design_data_iterate = design_iterate.design_update(self.update_prompt, self.component_string, self.wireframe, self.component_task)
